...
gulp.task('transfer', function() {
  return gulp.src(['index.html', 'caste-dotazy.html', 'tym.html', 'gdpr.html', 'audit-kod.html', 'robots.txt', 'peoples.json', 'css/styles.css', 'css/styles.css.map', 'js/scripts.js', 'js/scripts.js.map', 'img/**/*', 'navody/**/*', 'downloads/**/*'], { base:"." })
    .pipe(plumber({ errorHandler: onError }))
    .pipe(gulp.dest('dist/'));
});
