                ...
                <section class="section">
                    <div class="section__content">
                        ...
                        <div class="section__item" v-for="(platform, key) in ['android', 'ios']" :key="key">
                            ...
                            <p class="d-flex">
                                <a
                                    ...
                                    target="_blank"
                                    @click.prevent="openGallery($event, ((number - 1) + (4 * key)))"
                                    class="bpgallery"
                        ...
                        <div class="section__item">
                            ...
                            <p v-html="$t('web.faq.questions.sms_delivery_time.answer.1')"></p>
                            <div v-html="$t('web.faq.questions.sms_delivery_time.answer.2')"></div>
                        </div>
                        <div class="section__item">
