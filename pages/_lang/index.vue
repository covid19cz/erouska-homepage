        ...
        <main class="main d-flex" role="main">
            <div>
                <section class="section section--first">
                    <h2 class="section__title section__title--blue" id="jak-erouska-chrani">{{ $t('web.index.new_app') }}</h2>
                    <div class="section__content">
                        <div class="section__item">
                            <i18n path="web.index.basic_version_info" tag="p">
                        ...
                        <div class="section__item">
                            <h3>{{ $t('web.index.functions_question') }}</h3>
                            <ul v-html="$t('web.index.functions_list')"></ul>
                        </div>
                    </div>
                </section>
                <section class="section section--last">
                    ...
                    <div class="section__content">
                        ...
                        <div class="section__item">
                            <h3>{{ $t('web.index.basic_version_comparison.question') }}</h3>
                        ...
                        <div class="section__item">
                            <h3>{{ $t('web.index.data_security.question') }}</h3>
                            <i18n path="web.index.data_security.answer.text" tag="p">
                                <nuxt-link :to="homeUrl + 'audit-kod'">{{ $t('web.index.data_security.answer.independent_audits') }}</nuxt-link>
                            </i18n>
                        </div>
                        <div class="section__item">
                        ...
                        <div class="section__item">
                            ...
                            <i18n path="web.index.who_is_running_it.answer.text" tag="p">
                                ...
                                <a href="https://www.mzcr.cz/" target="_blank">{{ $t('web.index.who_is_running_it.answer.ministry') }}</a>
                                <a href="https://nakit.cz/" target="_blank">{{ $t('web.index.who_is_running_it.answer.nakit') }}</a>
                                <nuxt-link :to="homeUrl + 'tym'">{{ $t('web.index.who_is_running_it.answer.dev_team') }}</nuxt-link>
                            </i18n>
                        </div>
                    </div>
                </section>
